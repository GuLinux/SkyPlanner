...
class Session;
class FilterByCatalogue : public Wt::WCompositeWidget
{
public:
  FilterByCatalogue( Session &session, Wt::WContainerWidget *parent = 0);
